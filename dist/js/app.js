(() => {
  ...
  setTimeout(() => {
    ...
    document.addEventListener("DOMContentLoaded", () => {
      const e = document.querySelector(".nav-events"),
        t = document.querySelectorAll(".nav-events__btn");
      e &&
        e.addEventListener("click", (e) => {
          if (e.target.classList.contains("nav-events__btn")) {
            const n = e.target.dataset.tabsPath;
            t.forEach((e) => {
              e.classList.remove("_active");
            }),
              document
                .querySelector(`[data-tabs-path="${n}"]`)
                .classList.add("_active");
          }
        });
      const n = document.querySelectorAll(".social-connection__video");
      n &&
        n.forEach((e) => {
          e.addEventListener("click", (t) => {
            t.target.classList.contains("_icon-play") &&
              (e.querySelector("video").setAttribute("control", ""),
              e.classList.add("_play"));
          });
        });
      const i = document.querySelector(".about-assortiment__left");
      i &&
        i.addEventListener("click", (e) => {
          e.target.classList.contains("about-assortiment__btn") &&
            (i.classList.toggle("_show"),
            i.classList.contains("_show")
